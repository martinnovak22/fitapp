...
const resources = {
    en: {
        translation: {
            ...
            authRateLimited: 'Too many attempts. Please wait a moment before trying again.',
            error: 'Error',
            ...
            galleryFailed: 'Could not open the photo library. Please try again.',
            ...
            timerStart: 'Start',
            timerDone: 'Done',
            timerExpandHint: 'Open timer controls',
            stop: 'Stop',
            pause: 'Pause',
            resume: 'Resume',
            collapse: 'Collapse',
    ...
    cs: {
        translation: {
            ...
            addDropSet: 'Přidat pyramidovou sérii',
            cleanState: 'Prázdný stav',
            czech: 'Čeština',
            english: 'Angličtina',
            language: 'Jazyk',
            thisWeek: 'Tento týden',
            weekStreakLabel: 'Týdny v řadě',
            trainedLabel: 'Odcvičeno',
            sinceLastLabel: 'Poslední trénink',
            today: 'Dnes',
            daysShort: '{{count}} d',
            weeksShort: '{{count}} týd.',
            lastWorkout: 'Poslední trénink',
            setsCount_one: '{{count}} série',
            setsCount_few: '{{count}} série',
            setsCount_other: '{{count}} sérií',
            muscleBalance: 'Rozložení svalů',
            otherMuscleGroup: 'Ostatní',
            ...
            authRateLimited: 'Příliš mnoho pokusů. Počkejte prosím chvíli před dalším pokusem.',
            error: 'Chyba',
            ...
            cameraFailed: 'Fotoaparát se nepodařilo otevřít. Zkuste to prosím znovu.',
            galleryFailed: 'Galerii se nepodařilo otevřít. Zkuste to prosím znovu.',
            takePhoto: 'Vyfotit',
            ...
            timer: 'Časovač',
            timerCountdown: 'Odpočet',
            timerStopwatch: 'Stopky',
            timerCustom: 'Vlastní',
            timerStart: 'Spustit',
            timerDone: 'Hotovo',
            timerExpandHint: 'Otevřít ovládání časovače',
            stop: 'Zastavit',
            pause: 'Pozastavit',
            resume: 'Pokračovat',
            collapse: 'Sbalit',
