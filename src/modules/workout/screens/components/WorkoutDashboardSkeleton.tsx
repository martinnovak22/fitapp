    ...
    return (
        <View>
            ...
            <Card>
                ...
                <SkeletonBlock width="100%" height={48} borderRadius={Radius.md} style={{ marginTop: Spacing.md }} />
            </Card>
            ...
            <Card>
                ...
                <View style={[skeletonStyles.divider, { backgroundColor: theme.hairline, marginTop: Spacing.md }]} />
